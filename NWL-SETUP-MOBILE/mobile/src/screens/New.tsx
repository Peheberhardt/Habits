        ...
        <View className="flex-1 bg-background px-8 pt-16">
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom:100}}>
                ...
                <TextInput
                    ...
                    className="h-12 pl-4 rounded-lg mt-3 bg-zinc-900 border-2 text-white border-zinc-800 focus:border-green-600"
                ...
                <TouchableOpacity className="w-full h-16 flex-row items-center justify-center bg-green-600 rounded-md mt-6" activeOpacity={0.7} onPress={handleCreateNewHabit}>
                    <Feather
                        name="check"
                        size={20}
                        color={colors.white}
